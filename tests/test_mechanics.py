...
from mechanicAPI.app.models import db, Mechanic
from datetime import datetime
from mechanicAPI.app.utils import encode_token
...
def test_mechanic_update(self):
    ...
    self.assertEqual(response.json['name'], 'NEW_MECHANIC')